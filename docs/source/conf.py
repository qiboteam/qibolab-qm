...
project = "qibolab-qm"
copyright = "2025, The Qibo team"
author = "The Qibo team"

release = qibolab_qm.__version__
...
autodoc_mock_imports = ["qm", "qualang_tools"]
...
# custom title
html_title = "Qibolab QM · v" + release

html_theme_options = {
    "top_of_page_button": "edit",
    "source_repository": "https://github.com/qiboteam/qibolab-qm/",
    "source_branch": "main",
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/qiboteam/qibolab-qm",
            "html": """
...
def run_apidoc(_):
    ...
    package = source.parents[1] / "src" / "qibolab_qm"
